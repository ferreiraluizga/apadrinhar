...
<head>
    ...
    <style>
        ...
        .banner {
            background-image: url(assets/img/banner_meus_apadrinhados.png);
...
<body>
    ...
    <div class="main-content">
        <section class="banner d-flex justify-content-start align-items-end p-4">
            <div class="container">
                <h1 class="fw-semibold text-white display-4">Meus Apadrinhados</h1>
            </div>
        </section>
        <div class="container px-4">
            <div class="row mb-5">
                <?php
                $hasApadrinhados = false; // Variável para verificar se há apadrinhados

                foreach ($apadrinhados as $apadrinhado) {
                    if ($apadrinhado['id_padrinho'] == $_SESSION['id_padrinho']) {
                        $hasApadrinhados = true; ?>
                        <div class="col-12 col-md-4 g-5">
                            <div class="card border-0">
                                ...
                                ?>
                                <a href="#" data-id="<?php echo $apadrinhado['id_apadrinhado']; ?>" data-nome="<?php echo $apadrinhado['nome_apadrinhado']; ?>" data-telefone="<?php echo $apadrinhado['telefone_apadrinhado']; ?>" data-imagem="<?php echo $userImage; ?>" data-bs-toggle="modal" data-bs-target="#modal_perfil">
                                    <img src="<?php echo $userImage; ?>" alt="Usuário" class="card-img-top">
                                </a>
                                <div class="card-body">
                                    <h5 class="card-title fw-semibold"><?php echo $apadrinhado['nome_apadrinhado']; ?></h5>
                                    <p class="card-text"><?php echo $apadrinhado['descricao_apadrinhado']; ?></p>
                                    <a href="consultar_apadrinhado.php?id=<?php echo $apadrinhado['id_apadrinhado']; ?>" class="btn btn-primaryBrown">Ver Mais</a>
                                </div>
                            </div>
                        </div>
                <?php }
                ...
                if (!$hasApadrinhados) {
                    echo '<div class="col-12 text-center mt-4"><p class="text-muted">Você ainda não possui apadrinhados.</p></div>';
                }
                ?>
            </div>
        </div>
