...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container px-4">
            <form method="post" class="row g-3 needs-validation" novalidate action="controller/discipuladoController.php?action=insert">
                <div class="col-12">
                    <?php if (isset($_GET['status']) && $_GET['status'] == 'completed') { ?>
                        <div class="alert fw-semibold text-white bg-secondaryBlue" role="alert">
                            Discipulado registrado com sucesso!<br>
                            <a href="discipulados.php" class="text-white">Clique aqui e veja os discipulados anteriores</a>
                        </div>
                    <?php } ?>
                </div>
                ...
                <div class="col-12 col-md-8">
                    ...
                    <input type="text" class="form-control" id="local" name="local" placeholder="Digite o lugar do seu discipulado" required>
                    <div class="invalid-feedback">
                        Preencha o campo para continuar.
                    </div>
                </div>
                <div class="col-12">
                    ...
                    <textarea class="form-control" id="descricao" name="descricao" rows="6" placeholder="Descreva seu discipulado com detalhes" required></textarea>
                    <div class="invalid-feedback">
                        Preencha o campo para continuar.
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="privado" name="nivel_acesso" id="nivel_acesso">
                ...
                <div class="col-12 mb-5">
                    <button class="btn btn-primaryBrown" type="submit">Adicionar Discipulado</button>
                </div>
            </form>
        </div>
    </div>
