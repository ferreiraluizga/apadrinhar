...
<body>
    ...
    <div class="main-content">
        <section class="banner d-flex justify-content-start align-items-end p-4">
            <div class="container">
                <h1 class="fw-semibold text-white display-4">Padrinhos</h1>
            </div>
        </section>
        <div class="container px-4">
            <div class="row mb-5">
                <?php if (count($padrinhos) > 0) {
                        ...
                        if ($padrinho['id_padrinho'] != $_SESSION['id_padrinho']) { ?>
                            <div class="col-12 col-md-4 g-5">
                                <div class="card border-0">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title fw-semibold"><?php echo $padrinho['nome_padrinho']; ?></h5>
                                        <p class="card-text"><?php echo $padrinho['descricao_padrinho']; ?></p>
                                        <hr>
                                        <p>
                                            <span class="fw-semibold">Apadrinhados:</span>
                                            <br>
                                            <?php
                                            $apadrinhados = $padrinhoController->list_apadrinhados_by_padrinho($padrinho['id_padrinho']);
                                            if (count($apadrinhados) > 0) {
                                        ...
                                        <a href="consultar_padrinho.php?id=<?php echo $padrinho['id_padrinho']; ?>" class="btn btn-primaryBrown">Ver Mais</a>
                                    </div>
                                </div>
                            </div>
                    <?php }
