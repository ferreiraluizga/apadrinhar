...
<body>
    ...
    <div class="main-content">
        <section class="banner d-flex justify-content-start align-items-end p-4 mb-5">
            <div class="container">
                <h1 class="fw-semibold text-white display-4">Cadastro de Apadrinhados</h1>
            </div>
        </section>
        <div class="container px-4">
            <form method="post" id="apadrinhado" class="row g-3 needs-validation" novalidate action="controller/apadrinhadoController.php?action=insert">
                <div class="col-12">
                    <?php if (isset($_GET['status']) && $_GET['status'] == 'completed') { ?>
                        <div class="alert fw-semibold text-white bg-secondaryBlue" role="alert">
                            Apadrinhado cadastrado com sucesso!<br>
                            <a href="apadrinhados.php" class="text-white">Clique aqui e veja todos os apadrinhados</a>
                        </div>
                    <?php } ?>
                </div>
                <div class="col-12 col-md-8">
                    <label for="name" class="form-label">Nome Completo</label>
                    <input type="text" class="form-control" name="nome" id="nome" placeholder="Digite o nome do apadrinhado" required>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="text" class="form-control" name="phone" id="phone" pattern="\(\d{2}\) \d{4,5}-\d{4}" placeholder="Digite o telefone do apadrinhado" required>
                    <div class="invalid-feedback">
                        Preencha o campo para continuar.
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <select class="form-select" id="temperamento" name="temperamento" required>
                        <option value="" selected disabled>Selecione um Temperamento</option>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <select class="form-select" id="comportamento" name="comportamento" required>
                        <option value="" selected disabled>Selecione um Comportamento</option>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <select class="form-select" id="linguagem" name="linguagem" required>
                        <option value="" selected disabled>Selecione uma Linguagem de Amor</option>
                ...
                <div class="col-12" id="ministerios-container" style="display: none;">
                    ...
                    <?php foreach ($ministerios as $ministerio) { ?>
                        <div class="form-check-inline">
                            <input class="form-check-input" type="checkbox" name="ministerios[]" value="<?php echo $ministerio['id_ministerio'] ?>" id="ministerios[]">
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" id="descricao" name="descricao" rows="5" placeholder="Digite a descrição e observações sobre o apadrinhado" required></textarea>
                    <div class="invalid-feedback">
                        Preencha o campo para continuar.
                    </div>
                </div>
                <div class="col-12 mb-5">
                    <button class="btn btn-primaryBrown" id="cadastrar" type="submit">Cadastrar Apadrinhado</button>
                </div>
            </form>
        </div>
    </div>
